...
class _CourseErrorStats(object):
    ...
    def __init__(self):
        ...
        self.num_of_videos_without_course_bound_in_val = 0
        self.videos_without_edx_video_id = []
        self.videos_without_course_bound_in_val = []
    ...
    def on_course_not_bound_to_video(self, block_key):
        ...
        Updates error data for the given block.
        """
        self.num_of_videos_without_course_bound_in_val += 1
        # self.videos_without_course_bound_in_val.append(unicode(block_key))
...
class _VideoErrorStats(object):
    ...
    def __init__(self):
        ...
        self.total_num_of_videos_without_course_bound_in_val = 0
    ...
    def on_course_not_bound_to_video(self, course_key, block_key):
        ...
        Updates error data for the given block.
        """
        self.total_num_of_videos_without_course_bound_in_val += 1
        if course_key not in self.stats_by_course:
            self.total_num_of_courses_with_errors += 1
